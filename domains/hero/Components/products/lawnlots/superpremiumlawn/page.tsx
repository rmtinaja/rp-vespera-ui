...
export default function Page() {
  return (
    <section className="lawn min-h-screen w-full overflow-hidden flex">
      <div className="flex flex-col lg:flex-row w-full">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-5 lg:px-10 relative">
          ...
          {/* TITLE */}
          <h1 className="text-2xl lg:text-3xl font-bold">Super Premium Lawn</h1>

          {/* DESCRIPTION */}
          <p className="text-base lg:text-lg my-4 lg:my-6 leading-relaxed">
            Right beside the road for easy access and elevated presence, the
            Super Premium Lawn is a choice of quiet confidence — offering
          ...
          <div className="flex flex-col lg:pl-10 gap-2 text-sm lg:text-lg">
            ...
            <span className="flex flex-row gap-3">
              <SquareCheckBig />
              Distance from Road: Beside the road
            </span>
            <span className="flex flex-row gap-3">
              <SquareCheckBig />
            ...
            <table className="border border-black min-w-[600px] text-sm lg:text-base">
              ...
              <tbody>
                <tr className="text-center">
                  <td className="px-4 py-2 border">58,000</td>
                  <td className="px-4 py-2 border">385</td>
                  <td className="px-4 py-2 border">725</td>
                  <td className="px-4 py-2 border">965</td>
                  <td className="px-4 py-2 border">1,255</td>
                  <td className="px-4 py-2 border">1,850</td>
